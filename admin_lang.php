...
$lang = array(
    ...
    'censored_wildcards' => 'Les jokers sont autorisés. Par exemple, le joker test* revient à censurer les mots  test, testing, tester, testeur, testament etc.',
    ...
    'toggle_extension_confirmation' => 'Etes-vous certain(e) de lancer cette action?',
    ...
    'allow_member_loc_notes' => 'Si réglé sur \'non\' toutes les heures et dates seront localisées dans le site maître par défaut.',
    ...
    'auto_assign_cat_parents_exp' => 'Si réglé sur \'oui\', à l\'occasion de nouvelles entrées, la catégorie parente sera automatiquement assignée même si vous choisissez une catégorie enfant',
    ...
    'caching_driver_failover' => 'Impossible de se connecter à %s, en utilisant le driver %s ',

    'caching_driver_file_fail' => 'Impossible d\'utiliser le driver %s, vérifier les permissions de routage du cache',
    ...
    'click_to_recount' => 'Cliquer pour recompter les rangées %x à travers %y',
    ...
    'default_primary_role' => 'Groupe de membres assigné par défaut aux nouveaux membres',
    ...
    'edit_groups' => 'Editer les assignations de groupe',
    ...
    'enable_sql_caching_exp' => 'Cette fonctionnalité améliorera la vitesse de chargement de vos pages grâce à des requêtes de cache qui sont normalement exécutées de façon dynamique. Activez-la seulement si vous n\'utilisez pas la fonctionnalité \'entrées futures\' ou \'entrées expirables\' .',
    ...
    'illegal_characters' => 'Le  nom que vous avez saisi ne peut contenir que des caractères alphanumériques, des soulignements et des tirets',

    'image_cfg' => 'Préférences de redimensionnement d\'image',

    'image_library_path' => 'Chemin de conversion d\'image',

    'image_library_path_exp' => 'Que vous choisissiez ImageMagick ou NetPBM, vous devez préciser
    ...
    'invalid_status_name' => 'Les noms de statuts ne peuvent contenir que des caractères alphanumériques de même que des espaces, des soulignements et des tirets .',
    ...
    'max_page_loads_exp' => 'Le nombre total de fois qu\'un utilisateur est autorisé à charger n\'importe laquelle de vos pages web (à l\'intérieur de l\'intervalle temps ci-dessus) avant d\'être verrouillé.',
    ...
    'must_be_path' => 'Notez: cela doit correspondre à un chemin de serveur complet et non une URL. Les permissions de dossier doivent être réglées sur 777.',
    ...
    'not_writable_path' => 'Le chemin que vous avez saisi n\'est pas accessible en écriture. Merci de vous assurer que les permissions de fichiers soient réglées sur 777.',
    ...
    'publish_tab_behavior' => 'Comportement de la tabulation Publier',
    ...
    'redirect_submitted_links' => 'Appliquer le déni de rang aux liens saisi par les utilisateurs?',
    ...
    'show_message' => 'Montrer me message personnalisé',
    ...
    'site_404_exp' => 'Détermmine quel modèle devrait être affiché lorsque quelqu\'un essaie d\'accéder à une URL invalide.',
    ...
    'sites_tab_behavior' => 'Tabulation de comportement des sites',
    ...
    'sql_query_instructions' => 'Utiliser ce formulaire pour soumettre une requête SQL',
    ...
    'thumbnail_prefix' => ' Suffixe image miniature',

    'thumbnail_prefix_exp' => 'Ce suffixe sera ajouté à toutes les miniatures auto-générées. Exemple: photo_thumb.jpg',
