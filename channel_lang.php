...
$lang = array(
    ...
    'add_tab' => 'Ajouter une tabulation',
    ...
    'category_groups_desc' => 'Assigner un ou plusieurs groupes de catégories à ce canal.',
    ...
    'channel_set_duplicates_error_desc' => 'Cet ensemble de canaux utilise des noms qui existent déjà sur votre site. Merci de renommer les items suivants.',
    ...
    'channel_set_upload_error_desc' => 'Nous avons été dans l\'impossibilité d\'importer le canal, merci de vérifier que votre dossier de cache soit réinscriptible.',

    'channel_set_filetype_error' => 'Impossible d\'importer le canal',

    'channel_set_filetype_error_desc' => 'Nous avons été dans l\'impossibilité d\'importer le canal; seuls les fichiers zip sont supportés.',

    'channel_set_invalid' => 'Ensemble de canaux invalides. Il manque le fichier channel_set.json.',
    ...
    'create_layout_error_desc' => 'Nous sommes dans l\'impossibilité de mettre à jour ce groupe, merci de passer en revue et de corriger les erreurs ci-dessous',
    ...
    'duplicate_tab_name' => 'Une tabulation utilisant ce nom existe déjà.',
    ...
    'edit_layout_error_desc' => 'Nous avons été dans l\'impossibilité de mettre à jour ce groupe, merci de passer en revue et de corriger les erreurs ci-dessous.',
    ...
    'error_cannot_hide_tab' => 'Impossible de dissimuler la tabulation',

    'error_cannot_remove_tab' => 'Impossible de supprimer la tabulation',

    'error_tab_has_fields' => '<b>%s</b> contient au minimum un champ et ne peut donc être supprimé. Merci de déplacer tous les champs dans une autre tabulation.',

    'error_tab_has_required_fields' => '<b>%s</b> contient au minimum un champ requis et ne peut être dissimulé. Merci de déplacer les champs requis dans une autre tabulation.',
    ...
    'field_groups_desc' => 'Assigner un ou plusieurs groupes de champs à ce canal.',

    'fields_desc' => 'Assigner un ou plusieurs champs à ce canal.',

    'form_layouts' => 'Affichage des publications',

    'edit_layout' => 'Editer l\'affichage',

    'illegal_tab_name' => 'Les noms des tabulations ne doivent pas contenir ces caractères *, >, :, +, (, ), [, ], =, |, ", \', ., #, ou $',
    ...
    'short_name' => 'Nom raccourci',

    'short_name_col' => 'Nom raccourci',

    'tab_name' => 'Nom de la tabulation',

    'tab_name_desc' => 'Nom raccourci pour cette tabulation.',

    'tab_name_required' => 'Merci de choisir un nom pour cette tabulation.',
    ...
    'channel_not_created_desc' => 'Nous sommes dans l\'impossibilité de créer ce canal, merci de passer en revue et de corriger les erreurs exposées ci-dessous',

    'channel_not_updated' => 'Impossible de mettre à jour le canal',

    'channel_not_updated_desc' => 'Nous sommes dans l\'impossibilité de mettre à jour ce canal, merci de passer en revue et de corriger les erreurs exposées ci-dessous.',
    ...
    'invalid_short_name' => 'Le nom de votre canal ne doit comporter que des caractères alpha-numériques et aucun espace.',
    ...
    'channel_form_default_author' => 'Auteur(e)',

    'channel_form_default_author_desc' => 'Auteur(es) par défaut pour les entrées publiées par des invités à travers ce formulaire de canal.',
    ...
    'convert_urls_emails_to_links' => 'Restituer les <abbr title="Unified Resource Locator">URL</abbr> et adresses email sous forme de liens ?',

    'convert_urls_emails_to_links_desc' => 'Si activé, les <abbr title="Unified Resource Locator">URL</abbr> et adresses email seront restituées sous forme de liens dans les entrées de ce canal.',
    ...
    'default_category_desc' => 'Catégorie assignée à toutes les <b>nouvelles</b> entrées de ce canal.',

    'default_status' => 'Statut',

    'default_status_desc' => 'Statut assigné à toutes les <b>nouvelles</b> entrées de ce canal.',

    'default_title' => 'Titre généré',

    'default_title_desc' => 'Titre assigné à toutes les <b>nouvelles</b> entrées de ce canal.',

    'enable_author_notification' => 'Activer les notifications d\'auteur(e)?',

    'enable_author_notification_desc' => 'Si activé, l\'auteur(e) d\'une entrée sera notifié(e) quand quelqu\'un publiera des commentaires qui lui sont rattachés.',
    ...
    'max_versions' => 'Nombre maximum de versions par entrée',
    ...
    'url_title_prefix_desc' => 'Titre de préfixe <abbr title="Unified Resource Locator">URL</abbr> assigné à toutes les <b>nouvelles</b> entrées de ce canal.',
    ...
    'category_field_not_created_desc' => 'Nous avons été dans l\'impossibilité de créer ce champ de catégorie, merci de réviser et de corriger les erreurs ci-dessous.',

    'category_field_not_updated' => 'Impossible de mettre à jour le champ de catégorie',

    'category_field_not_updated_desc' => 'Nous avons été dans l\'impossibilité de mettre à jour ce champ de catégorie, merci de passer en revue et de corriger les erreurs ci-dessous.',
    ...
    'category_fields_desc' => 'Assigner les champs à ce groupe.',
    ...
    'category_group_not_created_desc' => 'Nous avons été dans l\'impossibilité de créer ce groupe de catégories, merci de passer en revue et de corriger les erreurs ci-dessous.',

    'category_group_not_updated' => 'Impossible de mettre à jour ce groupe de catégories',

    'category_group_not_updated_desc' => 'Nous avons été dans l\'impossibilité de mettre à jour ce groupe de catégories, merci de passer en revue et de corriger les erreurs ci-dessous.',
    ...
    'category_not_created_desc' => 'Nous avons été dans l\'impossibilité de créer cette catégorie, merci de passer en revue et de corriger les erreurs ci-dessous.',

    'category_not_updated' => 'Impossible de mettre à jour la catégorie',

    'category_not_updated_desc' => 'Nous avons été dans l\'impossibilité de mettre à jour cette catégorie, merci de passer en revue et de corriger les erreurs ci-dessous.',
    ...
    'category_permissions_warning2' => 'N\'importe quel réglage annoté avec %s devrait être accordé aux personnes auxquelles vous faites implicitement confiance.',
    ...
    'edit_categories_desc' => 'Les utilisateurs dans les rôles sélectionnés seront autoriseés à éditer les catégories dans ce groupe.</em><em>Les Super Administrateurs sont <b>toujours</b> habilités.',
    ...
    'exclude_group_form_desc' => 'Empêcher ce groupe de catégories d\'être offert comme un choix possible à assigner aux canaux et aux répertoires de fichiers.',
    ...
    'status_ajax_reorder_fail_desc' => 'Nous avons été dans l\'impossibilité de sauvegarder votre classement de statuts. Rafraîchir la page et vérifier que vous êtes connecté(e).',
    ...
    'status_not_created_desc' => 'Nous avons été dans l\'impossibilité de créer ce statut, merci de passer en revue et de corriger les erreurs ci-dessous.',

    'status_not_updated' => 'Impossible de mettre à jour le statut',

    'status_not_updated_desc' => 'Nous avons été dans l\'impossibilité de mettre à jour ce statut, merci de passer en revue et de corriger les erreurs ci-dessous.',
    ...
    'statuses_desc' => 'Assigner un ou plusieurs statuts à ce canal.',
