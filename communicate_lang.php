...
$lang = array(
    ...
    'batch_size_is_zero' => 'Le mode Batch (envoi par paquets) est activé mais le volune du batch n\'est pas réglé correctement. Consulter votre <a href="' . DOC_URL . '/general/system_configuration_overrides.html#email-batch-size" rel="external">Email Configuration Overrides</a> dans votre fichier de config.',
    ...
    'currently_sending_batch' => 'Envoi en cours d\'emails %x à travers %y',

    'delete_confirm' => 'Confirmation de suppression d\'email',

    'delete_emails' => 'Supprimer l\'email',

    'delete_question' => 'Etes-vous certain(e) de vouloir supprimer les emails précisés?',
