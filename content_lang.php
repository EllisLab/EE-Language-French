...
$lang = array(
    ...
    'author_information' => 'Information sur l\'auteur(e)',

    'author_information_desc' => 'Information relative à l\'auteur(e) de ce commentaire, non éditable.',
    ...
    'create_entry_error_desc' => 'Nous avons été dans l\'impossibilité de créer cette entrée, merci de passer en revue et de corriger les erreurs ci-dessous.',
    ...
    'edit_comment_error_desc' => 'Nous avons été dans l\'impossibilité d\'éditer le commentaire, merci de passer en revue et de corriger les erreurs ci-dessous.',
    ...
    'edit_entry_error_desc' => 'Nous avons été dans l\'impossibilité de mettre à jour cette entrée, merci de passer en revue et de corriger les erreurs ci-dessous.',
    ...
    'sticky_desc' => 'Si activé, cette entrée sera toujours priorisée dans les listes triées.',
    ...
    'add_author' => 'Ajouter auteur(e)',

    'add_author_desc' => 'Les réglages de groupes écrasent les réglages individuels, et certains utilisateurs n\'ont pas pu être retirés de cette liste d\'auteur(e)s.',
    ...
    'autosave_data_available' => 'Donnée auto-sauvegardée disponible',

    'autosave_success' => 'Auto sauvegardée',
    ...
    'autosaved' => 'Auto-sauvegardée',

    'autosaved_entries' => 'Entrées auto-sauvegardées',

    'autosaved_versions' => 'Versions auto-sauvegardées',

    'autosaved_versions_desc' => 'Ci-dessous, figure la liste des versions auto-sauvegardées de cette entrée.',

    'autosaves' => 'Sauvegarde automatiquement',

    'blockquote' => 'Bloc de texte',
    ...
    'delete_entries_confirm' => 'Etes-vous certain(e) de vouloir supprimer ces entrées de façon définitive?',

    'delete_entry_confirm' => 'Etes-vous certain(e) de vouloir supprimer cette entrée de façon définitive?',

    'delete_selected' => 'Supprimer a été choisi',

    'descending' => 'La plus récente en premier',

    'discard_autosave' => 'Renoncer aux données auto-sauvegardées',
    ...
    'forum_body' => 'Text du sujet de forum',
    ...
    'hide_toolbar' => 'Cacher la barre d\'outils',
    ...
    'html_buttons_no_cursor' => 'A des fins d\'utiliser ces boutons, vous devez d\'abord placer votre curseur dans ce champ.',
    ...
    'missing_date' => 'Votre entrée canal doit posséder une date.',
    ...
    'no_autosave_data' => 'Pas d\'entrées auto-sauvegardées',

    'no_categories' => 'Aucune catégorie n\'a été assignée à ce canal.',

    'no_categories_assigned' => 'Pas de catégorie assignée',

    'no_categories_assigned_desc' => 'Il n\'y a pas de catégorie assignée à ce canal. <a href="%s" target="_blank">Assigner un groupe de catégories.</a>',
    ...
    'no_channels' => 'Vous n\'avez aucun canal qui vous est assigné pour ce site.',
    ...
    'spam_comments' => 'Il y a <b>%d commentairess</b> fléchés comme de potentiels pourriels et qui <a href="%s">nécessitent une modération</a>.',
    ...
    'tab_count_zero' => 'Il faut impérativement une tabulation disponible pour rassembler les champs.',

    'tab_has_req_field' => 'La tabulation devrait peut-être ne pas être supprimée alors qu\'elle contient les champs requis suivants:: ',
    ...
    'this_entry_will_appear_in' => 'Cete entrée va apparaître dans:',
    ...
    'unauthorized_to_delete_others' => 'Vous êtes seulement autorisé(e) à supprimer les entrées de canal dont vous êtes l\'auteur(e)',
    ...
    'layout_failure_invalid_name' => 'Les champs suivants ont des caractères non valides dans les noms raccourcis: ',

    'layout_failure_required' => 'Les champs suivants sont requis et ne peuvent être dissimulés: ',
    ...
    'unable_to_load_tab' => 'Nous sommes dans l\'impossibilité de charger le fichier tab de publication sollicité: %s',
    ...
    'bulk_edit_add_categories_notice' => 'N\'importe laquelle des catégories choisies se verra assigner les entrées sélectionnées <b>en complément</b> des sélections des catégories actuelles, relatives à ces entrées.',

    'bulk_edit_destructive' => 'ceci est une action irréversible et destructrice.',

    'bulk_edit_notice' => 'N\'importe lequel des champs sélectionnés va écraser le contenu de ce champ enregistré pour toutes les entrées sélectionnées.',

    'bulk_edit_remove_categories_notice' => 'N\'importe laquelle des catégories sélectionnées sera <b>retirée</b> des entrées choisies, laissant intactes les assignations de catégories des autres entrées.',

    'remove_categories' => 'Retirer les catégories',

    'remove_categories_entries' => 'Retirer les catégories des %d entrées',
    ...
    'entry_manager_view_not_created_desc' => 'Nous sommes dans l\'impossibilité de créer cette visualisation, merci de passer en revue et de corriger les erreurs ci-dessous.',

    'entry_manager_view_not_updated' => 'Impossible de mettre à jour la visualisation',

    'entry_manager_view_not_updated_desc' => 'Nous sommes dans l\'impossibilité de mettre à jour la visualisation, merci de passer en revue et de corriger les erreurs ci-dessous.',
