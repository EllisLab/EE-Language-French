...
$lang = array(
    ...
    'checksum_changed_warning' => 'Un ou plusieurs fichiers core (système) ont été altérés:',

    'checksum_email_message' => 'ExpressionEngine a détecté la modification d\'un fichier core (système) sur: {url}

Les fichiers suivants ont été affectés:
{changed}

Si vous êtes l\'auteur(e) de ces changements, merci d\'accepter les modifications sur la page d\'accueil du tableau de bord. Si vous n\'avez pas vous-même modifié ces fichiers, cela peut être une indication que vous êtes victime d\'une tentative de piratage. Vérifiez que les fichiers ne comprennent pas de contenus suspicieux (JavaScript ou iFrames) et allez voir: ' . DOC_URL . 'troubleshooting/error-messages.html#expressionengine-has-detected-the-modification-of-a-core-file',

    'checksum_email_subject' => 'Un fichier core (système) a été modifié sur votre site.',

    'warning_system_status_title' => 'Merci de vérifier le statut de système en ligne',

    'warning_system_status_message' => 'Le statut actuel de votre système est réglé sur <b>%s</b>. Si vous avez besoin d\'en changer, merci de visiter <a href="%s">Réglages système</a> ou cliquer sur le bouton ci-dessous.',
    ...
    'curl_not_installed' => 'cURL n\'est pas installé sur votre serveurr',
    ...
    'redirect_check_address' => 'Merci de vérifier que cette adresse soit en conformité.',
    ...
    'unwritable_cache_folder' => 'Votre dossier de cache n\'a pas les permissions requises.<br />Pour régler ce problème: réglez les permissions de dossier de cache (/' . SYSDIR . '/user/cache/) sur 777 (ou sur le réglage équivalent sur votre serveur).',
    ...
    'forgotten_email_sent' => 'Si cette adresse email est associée à un compte, les instructions pour ré-initaliser votre mot de passe viennent de vous être adressées par email.',
    ...
    'cookie_csrf_token_desc' => 'Un cookie de sécurité utilisé à des fins d\'authentifier l\'utilisateur et de prévenir des attaques "Cross Site Request Forgery" ',
