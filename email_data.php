...
if (! function_exists('admin_notify_entry_title')) {
    ...
    {
        return <<<EOF
Une nouvelle entrée canal a été publiée.
EOF;
    }
}
...
if (! function_exists('admin_notify_entry')) {
    ...
    {
        return <<<EOF
Une nouvelle entrée a été publiée au sein du canal suivant:
{channel_name}
...
Pour lire cette entrée, merci de rendre visite à:
{entry_url}
...
if (! function_exists('admin_notify_reg_title')) {
    ...
    {
        return <<<EOF
Notification d\'un nouvel enregistrement de membre.
EOF;
    }
}
...
if (! function_exists('admin_notify_reg')) {
    ...
    {
        return <<<EOF
Site du nouvel enregistrement de membre: {site_name}.

Nom d\'écran: {name}
Nom utilisateur: {username}
Email: {email}

l\'URL de votre tableau de bord: {control_panel_url}
EOF;
    }
}
...
if (! function_exists('admin_notify_comment_title')) {
    ...
    {
        return <<<EOF
Vous venez de recevoir un commentaire!
EOF;
    }
}
...
if (! function_exists('admin_notify_comment')) {
    ...
    {
        return <<<EOF
Vous venez de recevoir un commentaire pour le canal suivant:
{channel_name}
...
if (! function_exists('mbr_activation_instructions_title')) {
    ...
    {
        return <<<EOF
Ci-joint, votre code d\'activation.
EOF;
    }
}
...
if (! function_exists('mbr_activation_instructions')) {
    ...
    {
        return <<<EOF
Merci pour votre nouvelle inscription de membre!

Pour activer votre compte, veuillez vous rendre à l\'URL suivante:
...
if (! function_exists('forgot_password_instructions')) {
    ...
    {
        return <<<EOF
Pour réinitialiser votre mot de passe, merci de vous rendre sur la page suivante:

{reset_url}

Puis connectez-vous avec votre nom d\'utilisateur: {username}

Si vous ne souhaitez pas ré-initialiser votre mot de passe, ignorez ce message qui expirera dans 24h.
...
Si vous n\'êtes pas à l\'origine de ce changement, merci de contacter un administrateur sans délai.
...
if (! function_exists('email_changed_notification')) {
    ...
    {
        return <<<EOF
Votre adresse email a été modifiée et l\' adresse précédente n\'est désormais plus associée à votre compte.
...
if (! function_exists('forgot_username_instructions_title')) {
    ...
    {
        return <<<EOF
Information de nom d\'utilisateur.
EOF;
    }
}
...
Si vous n\'êtes pas à l\'origine de cette requête, merci de contacter un administrateur sans délai.
...
if (! function_exists('validated_member_notify')) {
    ...
    {
        return <<<EOF
Votre compte de membre a été activé et il est prêt à l\'emploi.
...
if (! function_exists('decline_member_validation_title')) {
    ...
    {
        return <<<EOF
Votre compte de membre a fait l\'objet d\'un refus.
EOF;
    }
}
...
if (! function_exists('decline_member_validation')) {
    ...
    {
        return <<<EOF
Nous en sommes désolés mais notre équipe a décidé de ne pas valider votre demande d\'adhésion.
...
if (! function_exists('comment_notification_title')) {
    ...
    {
        return <<<EOF
Quelqu\'un vient de répondre à votre commentaire.
EOF;
    }
}
...
if (! function_exists('comment_notification')) {
    ...
    {
        return <<<EOF
{name_of_commenter} vient de répondre à votre entrée à laquelle vous êtes abonné(e) ici:
{channel_name}

Titre de l\'entrée:
{entry_title}

Vous pouvez visualiser le commentaire à l\'URL suivante:
{comment_url}

{comment}

Pour cesser de recevoir des notifications relatives à ce commentaire, cliquer ici:
...
if (! function_exists('comments_opened_notification')) {
    ...
    {
        return <<<EOF
Des réponses ont été ajoutées à cette entrée à laquelle vous êtes abonné(e) ici:
{channel_name}

Titre de l\'entrée:
{entry_title}

Vous pouvez visualiser les commentaires à l\'URL suivante:
{comment_url}
...
Pour cesser de recevoir des notifications pour cette entrée, cliquer ici:
{notification_removal_url}
EOF;
    }
}
...
if (! function_exists('admin_notify_forum_post_title')) {
    ...
    {
        return <<<EOF
Quelqu’un a publié dans {forum_name}.
EOF;
    }
}
...
if (! function_exists('admin_notify_forum_post')) {
    ...
    {
        return <<<EOF
{name_of_poster} vient de soumettre une nouvelle publication dans {forum_name}.

Le titre de ce fil de discussion:
{title}

La publication peut être visualisée ici:
{post_url}
...
if (! function_exists('forum_post_notification_title')) {
    ...
    {
        return <<<EOF
Quelqu\'un vient de publier dans {forum_name}.
EOF;
    }
}
...
if (! function_exists('forum_post_notification')) {
    ...
    {
        return <<<EOF
Quelqu\'un a publié dans un fil auquel vous êtes abonné(e) ici:
{forum_name}
...
if (! function_exists('private_message_notification_title')) {
    ...
    {
        return <<<EOF
Quelqu\'un vous a adressé un message privé.
EOF;
    }
}
...
{sender_name} vient de vous adresser un message privé intitulé ‘{message_subject}’.

Vous pouvez visualiser ce message privé en vous connectant et en consultant votre boite de réception à:
{site_url}
...
Pour cesser de recevoir des notifications de messages privés, fermez cette option dans vos réglages d\'email.
...
if (! function_exists('pm_inbox_full_title')) {
    ...
    {
        return <<<EOF
Votre boite de réception de messages privés est remplie.
EOF;
    }
}
...
{sender_name} a tenté de vous adresser un message privé,
mais votre boite de réception est remplie, excédant le maximum autorisé de {pm_storage_limit}.

Merci de vous connecter et de retirer les messages non désirés de votre boite de réception ici:
{site_url}
EOF;
    }
}
...
if (! function_exists('forum_report_notification_title')) {
    ...
    {
        return <<<EOF
Information de publication dans {forum_name}.
EOF;
    }
}
...
if (! function_exists('forum_report_notification')) {
    ...
    {
        return <<<EOF
{reporter_name} vient de répondre à la publication écrite par {author} dans:
{forum_name}
...
La publication peut être retrouvée ici:
{post_url}
            ...
            <section class="wrap">
                <div class="panel redirect">
                    <div class="panel-heading">
                        <h3>Système hors-ligne</h3>
                    </div>
					<div class="panel-body">
					Ce site est actuellement hors-ligne.
                    </div>
                </div>
            </section>
        </section>
...
<html>
	<head>
		<title>Bienvenue dans ExpressionEngine!</title>
  ...
  <div class="panel-heading" style="text-align: center;">
    <h3>ExpressionEngine a été installé!</h3>
  </div>
  <div class="panel-body">
    <div class="updater-msg">
  		<p style="margin-bottom: 20px;">Si vous visualisez ce message, c\'est que tout s\'est bien passé.</p>
  		...
  		<div class="alert alert--attention">
            ...
            <div class="alert__content">
    			<p>Si vous êtes le propriétaire de ce site, merci de vous connecter à votre tableau de bord et créez votre premier modèle.</p>
    		</div>
  		</div>
  		<div class="alert alert--attention">
            <div class="alert__icon">
            ...
            <div class="alert__content">
    			<p>Si c\'est la première fois que vous utilisez ExpressionEngine CMS, assurez-vous de <a href="https://docs.expressionengine.com/latest/getting-started/the-big-picture.html">consulter la documentation</a> pour bien démarrer.</p>
    		</div>
  		</div>
  	</div>
  </div>
