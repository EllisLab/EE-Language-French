...
$lang = array(
    ...
    'directory_no_access' => 'Vous n\'avez pas d\'accès au répertoire spécifié pour ce champ',

    'file_undo_remove' => 'Annuler RETIRER',
    ...
    /* Relationships */
    'any_author' => 'N\'importe quel(le) auteur(e)',
    ...
    'rel_ft_allow_multi_desc' => 'Si activé, les auteur(e)s seront autorisé(e)s à créer des relations multiples.',

    'rel_ft_authors' => 'Auteur(e)s',

    'rel_ft_authors_desc' => 'Choisir les auteur(e)s pour limiter les entrées dans ce champ de relations.',
    ...
    'rel_ft_include_future' => 'Futures entrées',
    ...
    'duration_ft_units_desc' => 'Détermine la durée de description quand un(e) auteur(e) de contenus entre un nombre entier comme “42”.',
    ...
    'file_ft_configure_subtext' => 'Contrôle plus avant la façon dont le champ de fichiers doit se comporter.',
    ...
    'file_ft_no_upload_directories' => 'Il n\'y a actuellement pas de répertoire de téléchargement disponible. Merci <a href="%s">d\'ajouter un ou plusieurs répertoires de téléchargement</a> à utiliser dans le type de champs de fichier.',

    'file_ft_select_existing' => 'Sélectionner un fichier existant',

    'file_ft_show_files' => 'Montrer les fichiers existants?',

    'file_ft_show_files_desc' => 'Si activé, un menu déroulant avec des fichiers existants seront montrés aux auteur(e)s.',
    ...
    'file_dnd_choose_file_directory' => 'Choisir un réperoire de fichiers',
    ...
    'grid_allow_reorder' => 'Autoriser le ré-agencement des rangées?',
    ...
    'grid_fields' => 'Champs Grille (grid)',
    ...
    'grid_max_rows' => 'Rangées maximum',

    'grid_max_rows_desc' => 'Fixe le nombre maximum de rangées de données que cette grille peut accepter',

    'grid_min_rows' => 'Rangées minimum',

    'grid_min_rows_desc' => 'Fixe le nombre minimum de rangées de données que cette grille peut accepter',

    'grid_order_by' => 'Ranger par',
    ...
    'grid_text_direction' => 'Sens du texte?',
    ...
    'notes_note_content_desc' => 'Ce contenu apparaître comme une note dans le formulaire de publication. Le formatage Markdown est supporté.',
);
