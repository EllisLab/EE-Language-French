...
// Relationships
'rel_ft_options'			=> 'Options du champ relationnel',
'rel_ft_configure'			=> 'Configurer les relations',
'rel_ft_configure_subtext'	=> 'Quel contenu souhaitez-vous relier ?',
...
'rel_ft_limit_left'			=> 'Limiter les articles à',
'rel_ft_limit_right'		=> 'renvoyé',
'rel_ft_limit_subtext'		=> 'laisser la zone vide pour autoriser TOUS les articles',
...
'rel_ft_order_in'			=> 'dans',
'rel_ft_order_asc'			=> 'Ordre croissant',
'rel_ft_order_desc'			=> 'Ordre décroissant',
'rel_ft_allow_multi'		=> 'Autoriser les relations multiples ?',
'rel_ft_allow_multi_subtext'=> 'les auteurs seront autorisés à sélectionner plus d\'un article à relier',

// File
'file_ft_options'				=> 'Options du champ fichier',
...
'file_ft_content_type'			=> 'Type de fichier autorisé',
'file_ft_allowed_dirs'			=> 'Répertoire autorisé',
'file_ft_configure_frontend'	=> 'Options de l\'interface utilisateur',
'file_ft_configure_frontend_subtext' => 'Modifie le comportement du champ quand il est utilisé à l\'intérieur d\'une balise {channel:form}.',
'file_ft_show_files'			=> 'Afficher les fichiers existants ?',
'file_ft_show_files_subtext'	=> 'les auteurs pourront sélectionner un fichier existant dans un menu déroulant',
'file_ft_limit_left'			=> 'Limiter les fichiers existants à',
...
'grid_config'				=> 'Configurer la grille',
...
'grid_show'					=> 'Afficher',
'grid_col_label_required'	=> 'Il y a au moins une colonne sans label.',
...
'grid_add_row'				=> 'Ajouter une ligne',
'grid_add_column'			=> 'Ajouter une colonne',
'grid_delete_row'			=> 'Supprimer la ligne',
'grid_delete_column'		=> 'Supprimer la colonne',
'grid_copy_column'			=> 'Copier',
