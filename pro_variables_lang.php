...
$lang = array(
    ...
    'delete_group_conf' =>
    '<b>%s</b>: les variables de ce groupe seront dégroupées.',
    ...
    'variable_notes_help' =>
    'Ajouter des notes ou instructions à cette variable &mdash; le balisage est autorisé',
    ...
    'group_notes_help' =>
    'Ajouter des notes ou des instructions à ce groupe &mdash; le balisage est autorisé',
    ...
    'one_way_sync_help' =>
    'Si réglées sur OUI,les variables seront toujours synchronisées <i>du fichier vers la base de données</i> et non l\'inverse.',

    'sync_url' =>
    'Sync URL',

    'sync_url_help' =>
    'URL à utiliser pour déclencher la synchronisation de fichier. Ajouter <code>&amp;clear_cache=yes</code> pour nettoyer tous les caches en sus.',
