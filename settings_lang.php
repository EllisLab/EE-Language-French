...
$lang = array(
    ...
    'enable_msm_desc' => 'Si activé, les Super Admins et groupes de membres munis des permissions nécessaires auront la capacité de gérer des sites web additionnels depuis le <abbr title="Tableau de Bord">TB</abbr>.',

    'error_getting_version' => 'Vous utilisez ExpressionEngine %s. Nous n\'avons pas la possibilité de déterminer si a une nouvelle version est actuellement disponible.',
    ...
    'site_online_desc' => 'Si désactivé, seuls les Super Admins et les groupes de membres munis des permissions nécessaires auront la capacité de naviguer sur votre site web.',

    'site_short_name' => 'Raccourci',

    'site_short_name_taken' => 'Ce raccourci a déjà été emprunté.',
    ...
    'base_path_desc' => 'Utiliser <code>{base_path}</code> pour établir les chemins dans les champs qui leur sont réservés dans le tableau de bord.',
    ...
    'url_title_separator_opt_under' => 'Soulignement (differents_mots)',
    ...
    'unencrypted' => 'Non crypté (non recommendé)',
    ...
    'caching_driver_desc' => 'Les caches peuvent être rangés indifféremment dans un driver, soit de fichier soit de mémoire de base.',

    'caching_driver_failover' => 'Impossible de se connecter à %s, utilisation du driver %s à titre de remplacement.',

    'caching_driver_file_fail' => 'Impossible d\'utiliser le driver %s, vérifier les permissions de chemin du cache.',
    ...
    'enable_devlog_alerts_desc' => 'Si activé, les Super Admins verront les alertes du tableau de bord quand de nouveaux éléments du <a href="%s">journal de développeur</a> nécessiteront une action. Actuellement, il y a <b>%s élements(s)</b> journalisé(s).',
    ...
    'max_caches_desc' => 'Si vous mettez en cache vos pages ou votre base de données, cela limitera le nombre d\'instances de cache. Nous recommandons 150 pour des sites modestes et 300 pour ds sites plus volumineux. Le maximum autorisé est de 1000.',
    ...
    'enable_sql_caching_desc' => 'Si activé, la vitesse des pages dynamiques de canal sera améliorée. A ne <b>pas</b> utiliser, si vous avez besoin de fonctionnalités liées à de "futures entrées" ou  à des "entrées en voie d\'expiration".',
    ...
    /* Hit Tracking */
    'dynamic_tracking_disabling' => 'Suspendre le seuil?',
    ...
    'log_referrers' => 'Activer la traque des référents?',
    ...
    'allow_member_localization_desc' => 'Si activé, les membres auront la capacité de régler leur localisation spécifique des paramètres d\'heure et de date pour leur compte.',

    'allow_member_registration' => 'Autoriser les inscriptions?',

    'allow_member_registration_desc' => 'Si activé, les utilisateurs auront la capacité d\'inscrire des comptes de membre.',
    ...
    'memberlist_row_limit_desc' => 'Total des résultats retournés par page pour la liste des membres.',
    ...
    'prv_msg_attach_total' => 'Taille maximum totale autorisée de fichiers (<abbr title="megabits">mb</abbr>)',

    'prv_msg_attach_total_desc' => 'Taille maximum autorisée de fichiers pour l\'ensemble des fichiers de chaque membre.',
    ...
    'allow_dictionary_pw_desc' => 'Si activé, les membres auront la capacité d\'utiliser les noms communs du dictionnaire dans leurs mots de passe. <code>Requiert un fichier de dictionnaire à installer pour la mise en application.</code> <a href="' . DOC_URL . 'control-panel/settings/security-privacy.html#dictionary-file">En savoir plus</a>.',

    'allow_multi_logins' => 'Autoriser des sessions multiples?',

    'allow_multi_logins_desc' => 'Si désactivé, les membres n\'auront pas la capacité de se connecter depuis une nouvelle localisation ou depuis un nouveau navigateur, s\'il y a déjà une session active.',
    ...
    'require_ip_for_login_desc' => 'Si activé, les membres seront dans l\'impossibilité de se connecter sans un agent utilisateur valide et une adresse <abbr title="Internet Protocol">IP</abbr>.',

    'require_ip_for_posting' => 'Requérir un agent utilisateur et une <abbr title="Internet Protocol">IP</abbr> pour publier?',

    'require_ip_for_posting_desc' => 'Si activé, les membres seront dans l\'impossibilité de publier sans un agent utilisateur valide et une adresse <abbr title="Internet Protocol">IP</abbr>.',

    'password_security_policy' => 'Politique de sécurité de mot de passe',

    'password_security_policy_desc' => 'Choisir le niveau de sécurité de mot de passe que les membres du site se doivent de maintenir <a href="' . DOC_URL. 'control-panel/settings/security-privacy.html#password-security-policy" target="_blank">Lire plus</a> à-propos de options.',
    ...
    'security_tip_desc' => 'Tout réglage affecté du signe <span class="icon--caution" title="security enhancement"></span> augmentera davantage et améliorera la sécurité du site.',
    ...
    'max_page_loads_desc' => 'Le nombre total de fois qu\'un utilisateur est autorisé à charger n\'importe quelle page web (à l\'intérieur de l\'intervalle ci-dessous) avant d\'être verrouillé.',
    ...
    'create_html_buttons_error_desc' => 'Nous avons été dans l\'impossibilité de créer ce bouton <abbr title="Hyper-Text Markup Language">HTML</abbr>, merci de passer en revue et de corriger les erreurs ci-dessous.',
    ...
    'edit_html_buttons_error_desc' => 'Nous avons été dans l\'impossibilité de mettre à jour ce bouton <abbr title="Hyper-Text Markup Language">HTML</abbr>, merci de passer en revue et de corriger les erreurs ci-dessous.',
