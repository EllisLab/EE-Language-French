...
'channel_form_layouts' => '%s &ndash; dispositions de formulaire',

'member_group' => 'Groupes de membres',

'no_layouts' => 'Aucune disposition',

'create_form_layout' => 'Créer une disposition de formulaire',
...
'create_layout_success' => 'Disposition de formulaire créée',

'create_layout_success_desc' => 'La disposition de formulaire <b>%s</b> a été créée.',

'create_layout_error' => 'Impossible de créer la disposition de formulaire',

'create_layout_error_desc' => 'Nous n\'avons pas pu créer la disposition de formulaire, merci de vérifier et corriger les erreurs ci-dessous.',

'btn_preview_layout' => 'Aperçu de la disposition',

'form_layouts' => 'Dispositions de formulaires',

'edit_form_layout' => 'Modifier la disposition de formulaire &ndash; %s',

'edit_layout_success' => 'Disposition de formulaire mise à jour',

'edit_layout_success_desc' => 'La disposition de formulaire <b>%s</b> a été mise à jour.',

'edit_layout_error' => 'Impossible de mettre à jour la disposition de formulaire',

'edit_layout_error_desc' => 'Nous n\'avons pas pu mettre à jour cette disposition de formulaire, merci de vérifier et corriger les erreurs ci-dessous.',

'layouts_removed_desc' => 'Les dispositions de formulaire suivantes ont été supprimées',
...
'tab_name_required'	=>
'Merci de choisir un nom pour votre onglet.',
...
'channel_settings' => 'Paramètres de canal',
...
'live_look_template_desc' => 'Modèle à utiliser pour la fonctionnalité <mark>aperçu rapide</mark>.',
...
'url_title_prefix' => 'Préfixe <abbr title="Unified Resource Locator">URL</abbr> de titre',

'url_title_prefix_desc' => 'Préfixe <abbr title="Unified Resource Locator">URL</abbr> de titre affecté à tous les <b>nouveaux</b> articles de ce canal.',
...
'extra_publish_controls_desc' => 'Si positionné à <b>Oui</b>, un deuxième jeu de contrôles de publication apparaîtra en haut du formulaire de publication pour ce canal.',

'convert_image_urls' => 'Autoriser les <abbr title="Unified Resource Locator">URL</abbr>s d\'images ?',

'convert_image_urls_desc' => 'Si positionné à <b>Oui</b>, les <abbr title="Unified Resource Locator">URL</abbr>s vers des sources images seront auto-magiquement restituées sous forme d\'images dans les articles de ce canal.',
...
'convert_urls_emails_to_links_desc' => 'Si positionné à <b>Oui</b>, les adresses email et les <abbr title="Unified Resource Locator">URL</abbr>s seront restituées sous forme de liens dans les articles de ce canal.',
...
'allow_guest_submission_desc' => 'Si positionné à <b>Oui</b>, les utilisateurs non inscrits pourront soumettre des formulaires pour ce canal.',

'versioning' => 'Versions',

'enable_versioning' => "Activer les versions d'articles ?",

'enable_versioning_desc' => 'S\'il est sur <b>Activer</b>, ExpressionEngine enregistrera des versions pour chaque article de ce canal.',
...
'enable_author_notification' => 'Activer les notifications des auteurs ?',

'enable_author_notification_desc' => 'S\'il est sur <b>Activer</b>, l\'auteur d\'un article sera notifié quand quelqu\'un fera un commentaire sur ce dernier.',

'enable_channel_entry_notification' => 'Activer la notification d\'article de canal ?',

'enable_channel_entry_notification_desc' => 'S\'il est sur <b>Activer</b>, tous les destinataires listés recevront une notification par email à chaque fois qu\'un nouvel article sera publié dans ce canal.</em>
<em>Séparez les emails multiples avec une <mark>virgule (,)</mark>.',

'enable_comment_notification' => 'Activer la notification de commenaire ?',

'enable_comment_notification_desc' => 'S\'il est sur <b>Activer</b>, tous les destinataires listés recevront une notification par email à chaque fois qu\'un nouveau commentaire sera publié dans ce canal.</em>
<em>Séparez les emails multiples avec une <mark>virgule (,)</mark>.',
...
'allow_comments_desc' => 'Si positionné à <b>Oui</b>, les membres peuvent soumettre des commentaires sur les articles de ce canal.',

'allow_comments_checked' => 'Autoriser les commentaires par défaut ?',

'allow_comments_checked_desc' => 'Si positionné à <b>Oui</b>, l\'option "Autoriser les commentaires" sera positionnée à "Oui" par défaut.',

'require_membership' => 'Inscription obligatoire ?',

'require_membership_desc' => 'Si positionné à <b>Oui</b>, seuls les membres inscrits peuvent soumettre des commentaires sur les articles de ce canal.',

'require_email' => 'Email obligatoire ?',

'require_email_desc'=>
'Si positionné à <b>Oui</b>, un membre doit fournir une adersse email valide pour soumettre des commentaires sur les articles de ce canal.',

'moderate_comments' => 'Modérer les commentaires ?',

'moderate_comments_desc' => 'Si positionné à <b>Oui</b>, les commentaire soumis seront mis dans une file d\'attente de modération et devront être approuvés par un Super Admin ou par un membre d\'un autre groupe ayant les permissions de modération.',
...
'comment_time_limit_desc' => 'Nombre de secondes entre 2 commentaires d\'un même membre.</em>
<em>Valeur 0 pour aucune limite.',

'comment_expiration' => 'Limite pour commenter',

'comment_expiration_desc' => 'Nombre de jours après qu\'un article soit publié au delà desquels les commentaires ne seront plus acceptés.</em>
<em>Laissez vide pour ne pas fixer de limite.',

'text_formatting' => 'Formatage de texte',

'text_formatting_desc' => 'Type de formatage de texte pour les commentaires.',

'comment_convert_image_urls_desc' => 'Si positionné à <b>Oui</b>, les <abbr title="Unified Resource Locator">URL</abbr>s vers des sources images seront auto-magiquement restituées sous forme d\'images dans les commentaires de ce canal.',

'comment_convert_urls_emails_to_links_desc' => 'Si positionné à <b>Oui</b>, les adresses email et les <abbr title="Unified Resource Locator">URL</abbr>s seront restituées sous forme de liens dans les commentaires de ce canal.',
...
'channel_settings_saved' => 'Paramètres de canal enregistrés',

'channel_settings_saved_desc' => 'Les paramètres du canal <b>%s</b> ont été enregistrés.',

'channel_settings_not_saved' => 'impossible d\'enregistrer les paramètres de canal',

'channel_settings_not_saved_desc' => 'Nous n\'avons pas pu enregistrer les paramètres de ce canal, merci de vérifier et corriger les erreurs ci-dessous.',
...
'create_category_group' => 'Créer un groupe de catégories',

'edit_category_group' => 'Modifier un groupe de catégories',

'category_groups_removed' => 'Groupes de catégories supprimés',

'category_groups_removed_desc' => '%d groupes de catégorie ont été supprimés.',
...
'cat_group_no_member_groups_found' => 'Aucun <b>groupe de membres</b> trouvé avec les permissions nécessaires',
...
'category_ajax_reorder_fail_desc' => 'Nous n\'avons pas réussi à enregistrer le nouvel ordre des catégories. Raffraîchissez la page et assurez-vous d\'être connecté.',
...
'cat_require_field_desc' => 'Si positionné à <b>Oui</b>, ce champ sera obligatoire pour soumettre le formulaire de publication.',
...
'cat_field_ajax_reorder_fail_desc' => 'Nous n\'avons pas réussi à enregistrer le nouvel ordre des champs de catégories. Raffraîchissez la page et assurez-vous d\'être connecté.',

/**
 * Groupes de statuts
 */

'status_groups' => 'Groupes de statuts',

'status_group' => 'Groupe de statuts',

'status_groups_removed' => 'Groupes de statuts supprimés',

'status_groups_removed_desc' => '%d groupes de statuts ont été supprimés.',

'create_status_group' => 'Créer un groupe de statuts',

'edit_status_group' => 'Modifier un groupe de statuts',

'status_group_created' => 'Groupe de statuts créé',

'status_group_created_desc' => 'Le groupe de statuts <b>%s</b> a été créé.',

'status_group_not_created' => 'Impossible de créer le groupe de statuts',

'status_group_not_created_desc' => 'Nous n\'avons pas pu créer ce groupe de statuts, merci de vérifier et corriger les erreurs ci-dessous.',

'status_group_updated' => 'Groupe de statuts mis à jour',

'status_group_updated_desc' => 'Le groupe de statuts <b>%s</b> a été mis à jour.',

'status_group_not_updated' => 'Impossible de mettre à jour le groupe de statuts',

'status_group_not_updated_desc' => 'Nous n\'avons pas pu mettre à jour ce groupe de statuts, merci de vérifier et corriger les erreurs ci-dessous.',
...
'status_ajax_reorder_fail_desc' => 'Nous n\'avons pas réussi à enregistrer le nouvel ordre des statuts. Raffraîchissez la page et assurez-vous d\'être connecté.',
...
'duplicate_status_group_name' => 'Un groupe de statuts existe déjà avec le même nom.',
