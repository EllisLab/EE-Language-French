...
'expiration_date_desc' => 'Date à laquelle cet article devrait expirer.',

'comment_expiration_date' => 'Date maxi pour commenter',

'comment_expiration_date_desc' => 'Date après laquelle les commentaires pour cet article ne devraient plus être acceptés.',
...
'sticky_desc' => 'Si positionné à <b>Oui</b>, cet article sera prioritaire et sortira en tête de liste des tris.',

'allow_comments' => 'Autoriser les commentaires ?',

'allow_comments_desc' => 'Si positionné à <b>Oui</b>, les membres ayant les permissions suffisantes pourront soumettre des commentaires pour cet article.',
...
'versioning_enabled_desc' => 'Si positionné à <b>Oui</b>, you can store up to %d revisions of this entry.',

'revision_warning' =>
'Vous êtes sur le point de charger une version précédente. Tout le contenu non enregistré sur cette page sera perdu.',
...
'Vous n\'êtes pas autorisé à modifier l\'article que vous avez sélectionné.',
...
'layout_save_warning' =>
'Si vous avez modifié votre disposition, les changements ne seront pas enregistrés.',

'autosave_success' =>
'Article enregistré automatiquement',

'autosave_title' =>
'Données enregistrées disponibles',

'autosave_warning_1' =>
'ExpressionEngine a enregistré des données de cet article avant sa sauvegarde.',

'autosave_warning_2' =>
'Les données enregistrées sont supprimées lorsque un article est enregistré ou re-enregistré.',
...
'Ce titre URL est utilisé par <b><a href="%s" rel="external">%s</a></b>. Les titres URL doivent être uniques.',
...
'no_channels' =>
'Aucun canal ne vous est affecté pour ce site.',
