...
"sig_too_big" =>
"Les signatures ne peuvent contenir que %x caractères",

"signature_image" =>
"Image de signature",

"sig_img_not_enabled" =>
"Les images de signature ne sont pas activées.",

"no_image_exists" =>
"L'image de signature n'existe pas",

"signature_updated" =>
"La signature a été mise à jour",

"remove_sig_image" =>
"Supprimer l'image de signature",

"sig_img_removed" =>
"L'image de signature a été supprimée",
...
"uploads_not_allowed" =>
"Le téléchargement d'image n'est pas activé",
...
"photos_not_enabled" =>
"Les photos de membre ne sont actuellement pas activées.",

"current_photo" =>
"Photo actuelle",

"no_photo_exists" =>
"La photo de membre n'existe pas",
...
"photo_updated" =>
"La photo de membre a été mise à jour",
...
"control_panel_home" =>
"Accueil du panneau de contrôle",
...
"max_image_size" =>
"Taille maximale d'image : %x X %y",

"allowed_image_types" =>
"Types d'images autorisés : gif, jpg, png",
...
"choose_selected" =>
"Choisir l'avatar sélectionné",

"current_avatar_set" =>
"Série actuel d'avatar :",

"avatars_not_found" =>
"Impossible de localiser les avatars désirés",

"image_assignment_error" =>
"Une erreur a été rencontrée en essayant d'affecter votre image",
...
"La taille maximale autorisée pour les images est de %s kiloctets",

"invalid_image_type" =>
"Les images doivent être du type suivant : jpg, jpeg, gif, png",

"avatar_removed" =>
"L'avatar a été supprimé",
...
"mbr_message_logged" =>
"Note : Les messages emails sont enregistrés et peuvent être consultés par les administrateurs du site",

"most_recent_forum_topic" =>
"Sujet de forum le plus récent",
...
"Voir tous les messages de ce membre",

"mbr_captcha" =>
"Saisissez le mot que vous voyez ci-dessous :",
...
"mbr_auto_login" =>
"Connexion automatique lors des prochaines visites",
...
"Un administrateur du site va activer votre compte et vous notifier lorsqu'il sera prêt à l'emploi.",

"mbr_membership_instructions_email" =>
"Un email contenant les instructions pour activer votre compte vient de vous être envoyé.",

"mbr_membership_instructions_cont" =>
"Veuillez vérifier votre courrier et suivre les instructions contenu dans l'email.",

"mbr_your_are_logged_in" =>
"Vous êtes connecté et prêt à utiliser votre nouveau compte.",

"mbr_activation" =>
"Activation de compte",

"mbr_problem_activating" =>
"Requête d'activation invalide.",

"mbr_activation_success" =>
"Votre compte a été activé.",

"mbr_may_now_log_in" =>
"Vous pouvez maintenant vous connecter et commencer à l'utiliser.",

"mbr_not_allowed_to_view_profiles" =>
"Vous n'êtes pas autorisé à consulter les profils de membre.",
...
"mbr_member_timezone" =>
"Fuseau horaire du membre",

"mbr_member_local_time" =>
"Heure local du membre",
...
"Vos préférences d'email ont été mise à jour avec succès",

"mbr_email_updated" =>
"Préférences d'email mises à jour",

"username_disallowed" =>
"L'administrateur n'autorise pas le changement d'identifiant",
...
"mbr_notepad_updated" =>
"Votre bloc note a été mis à jour",

"mbr_localization_settings_updated" =>
"Vos préférences de localisation ont été mises à jour avec succès",
...
"Vous devez cocher la case \"accepter les conditions d'utilisation\"",

"mbr_emails_not_match" =>
"Les emails fournis ne correspondent pas",
...
"Ce membre n'accepte actuellement pas les emails.",
...
"Ce message vous a été envoyé depuis votre compte sur :",

"mbr_email_forwarding_cont" =>
"Si vous ne souhaitez plus recevoir d'emails vous pouvez désactiver cette préférence dans votre page de profil.",

"mbr_email_error" =>
"Une erreur a été rencontrée lors de l'envoi de votre email.",
...
"Vous n'êtes pas autorisé à utiliser la console email",

"mbr_email_timelock_not_expired" =>
"Vous n'êtes autorisé à utiliser la console email que toutes les %x minutes.",

"mbr_you_are_registered" =>
"Vous êtes déjà inscrit et connecté.",

"profile_not_available" =>
"Le profil de membre que vous avez demandé est actuellement indisponible",

"mbr_preferences_updated" =>
"Préférences mises à jour",

"mbr_prefereces_have_been_updated" =>
"Les préférences de membre ont été mises à jour",
...
'ignore_list' =>
'Gérer la liste d\'ignorés',

'ignore_list_empty' =>
'Aucun membre n\'est ignoré',

'ignore_list_blurb' =>
'Utilisez ce formulaire pour gérer votre liste d\'ignorés',
...
'Supprimer le(s) membre(s) sélectionné(s)',
...
"Cliquez sur le nom d'un membre pour l'ajouter à votre liste d'ignorés",
