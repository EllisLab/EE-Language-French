...
'accesskey_desc' => 'Raccourci clavier pour initialiser ce bouton.',

'add_a_row' => 'Ajouter une ligne',

'add_preset_button' => 'Ajouter un bouton prédéfini :',
...
'create_field_error_desc' => 'Nous n\'avons pas pu créer ce champ, merci de vérifier et corriger les erreurs ci-dessous.',

'create_field_error' => 'Impossible de créer le champ',

'create_field_group_error_desc' => 'Nous n\'avons pas pu créer ce groupe de champs, merci de vérifier et corriger les erreurs ci-dessous.',

'create_field_group_error' => 'Impossible de créer le groupe de champs',

'create_field_group_success_desc' => 'Le groupe de champs <b>%s</b> a été créé.',

'create_field_group_success' => 'Groupe de champs créé',

'create_field_group_warning' => '<b>Attention</b> : des champs personnalisés doivent d\'abord exister pour que des groupes de champs puissent être créés.',

'create_field_group_warning2' => 'Créer <b>d\'abord</b> vos <a href="%s">champs personnalisés</a> !',
...
'create_html_button' => 'Créer un bouton <abbr title="Hyper-Text Markup Language">HTML</abbr>',

'custom_fields_not_found' => 'Aucun <b>champ personnalisé</b> trouvé',

'custom_fields' => 'Champs personnalisés',

'default_value' => 'Valeur par défaut',

'edit_field_error_desc' => 'Nous n\'avons pas pu mettre à jour ce champ, merci de vérifier et corriger les erreurs ci-dessous.',

'edit_field_error' => 'Impossible de mettre à jour le champ',

'edit_field_group_error_desc' => 'Nous n\'avons pas pu mettre à jour ce groupe de champs, merci de vérifier et corriger les erreurs ci-dessous.',

'edit_field_group_error' => 'Impossible de mettre à jour le groupe de champs',

'edit_field_group_success_desc' => 'Le groupe de champs <b>%s</b> a été mis à jour.',

'edit_field_group_success' => 'Groupe de champs mis à jour',

'edit_field_group' => 'Modifier le groupe de champs',

'edit_field_success_desc' => 'Le champ <b>%s</b> a été mis à jour.',

'edit_field_success' => 'Champ mis à jour',

'edit_html_button' => 'Modifier un bouton <abbr title="Hyper-Text Markup Language">HTML</abbr>',

'field_content_text_desc' => 'Type de contenu que ce champ peut accepter.',
...
'field_show_fmt_desc' => 'Si activé, les auteurs pourront modifier la valeur par défaut définie pour le formatage du texte de ce champ dans le formulaire de publication.',

'field_show_fmt' => 'Autoriser le contournement ?',

'field_text_direction_ltr' => "De gauche à droite",

'field_text_direction_rtl' => "De droite à gauche",

'field_text_direction' => "Sens du texte",
...
'hide_field_desc' => 'Si activé, ce champ sera masqué dans le formulaire de publication, avec un lien pour l\'afficher.',
...
'include_in_search_desc' => 'Si activé, ce champ sera intégré dans les recherches.',

'include_in_search' => 'Recherchable ?',

'instructions_desc' => 'Instructions pour le champ, telles qu\'elles seront affichées dans le formulaire de publication.',

'instructions' => 'Instructions',

'label_desc' => 'Nom du champ, tel qu\'il sera affiché dans le formulaire de publication.',

'localize_date_desc' => 'Si activé, les dates s\'appuieront sur les <a href="%s">paramètres de dates &amp; heure</a>.',
...
'no_buttons_found' => 'Aucun <b>bouton HTML</b> trouvé.',

'no_buttons' => 'Aucun bouton HTML n\'est défini.',

'no_value_label_pairs' => 'Aucune <b>paire valeur/étiquette</b> n\'existe.',

'options_field_desc' => 'Choisissez comment créer les options pour ce champ.</em><em><i>Les paires Valeur/Etiquette peuvent être utilisées pour faciliter la sélection du contenu par les auteurs. Par exemple, si vous devez stocker une valeur de <b>1</b>, vous pourriez utiliser une étiquette de <b>Un</b></i></em>',
...
'removed_field' => 'Ce champ a été retiré et ses données ont été supprimées : %s',

'removed_fields_from_fluid_field' => 'Ces champs ont été retirés du Champ Fluide <b>%s</b> et leurs données ont été supprimées : %s',

'require_field_desc' => 'Si activé, ce champ devra être obligatoirement renseigné pour que le formulaire de publication puisse être soumis.',

'save_html_button' => 'Enregistrer le bouton <abbr title="Hyper-Text Markup Language">HTML</abbr>',

'select_menu_options_desc' => 'Choisissez comment créer les options pour ce champ.',

'select_menu_options' => 'Options du menu déroulant',
...
'tag_close_desc' => 'Fin de ce que va produire ce bouton. Ex. <b><code>&lt;/b&gt;</code></b>',

'tag_open_desc' => 'Début de ce que va produire ce bouton. Ex. <b><code>&lt;b&gt;</code></b>',

'textarea_height_desc' => 'Hauteur de ce champ en nombre de lignes.',

'textarea_height' => 'Hauteur de la zone de texte',

'toggle_default_value_desc_cont' => '<b>Note</b> : s\'il est affecté à un canal possédant des articles, tous ces articles prendront cette valeur par défaut.',

'toggle_default_value_desc' => 'La position par défaut de ce commutateur à bascule pour ce champ lors de la publication de nouveaux articles.',
...
"edit_channel_prefs" => "Modifier les préférences du canal",

"edit_channel" => "Modifier le canal",

"edit_group_assignments" => "Modifier les groupes",

"edit_group_prefs" => "Modifier les préférences de groupe",
...
"fmt_has_changed" => "Note : Vous avez sélectionné un choix de formatage de champ différent de celui enregistré précedemment.",
...
"max_revisions_note" => "Les versions peuvent utiliser un espace considérable de la base de données, il est donc fortement recommandé de limiter leur nombre.",

"max_revisions" => "Nombre maximum de versions récentes par article",
...
"no_statuses" => "Aucun <b>statut</b> trouvé",
...
"update_existing_fields" => "Mettre à jour tous les articles existants ?",
...
'category_edited' => 'Catégorie modifiée',
...
'edit_cat_field' => 'Modifier le champ de catégorie',
...
"add_edit_categories" => "Ajouter/Modifier des catégories",
...
"edit_category_group" => "Modifier le groupe de catégories",

"edit_category" => "Modifier la catégorie",

"edit_group_name" => "Modifier le groupe",

"name_of_category_group" => "Nom du groupe de catégories",

"no_category_group_message" => "Il n'y a actuellement aucune catégorie",

"no_category_message" => "Il n'y a actuellement aucune catégorie affecté à ce groupe",
...
"add_edit_fields" => "Ajouter/Modifier des champs personnalisés",
...
"custom_field_edited" => "Champ personnalisé modifié",
...
"field_name_cont" => "Un seul mot, sans espaces. Soulignés (underscore) et tirets autorisés",
...
"invalid_field_type" => "Type de champ invalide",
...
'url_title_prefix' => "Préfixe URL du titre",

"add_edit_statuses" => "Ajouter/Modifier des statuts",
