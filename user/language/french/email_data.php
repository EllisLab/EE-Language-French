...
Si vous n'avez pas effectué cette modification vous-même, merci de contacter immédiatement un administrateur.
...
Votre adresse email a été modifiée et cette adresse email n'est plus associée à votre compte utilisateur.
...
<html>
	<head>
		<title>Bienvenue sur ExpressionEngine !</title>
		<meta http-equiv="content-type" content="text/html; charset=utf-8" lang="fr-fr" dir="ltr">
		<meta content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no"  name="viewport">
  ...
  <div class="panel-body">
    <div class="updater-msg">
  		<p style="margin-bottom: 20px;">Si vous voyez ce message c'est que tout s'est bien déroulé.</p>
  		...
  		<div class="alert alert--attention">
            ...
            <div class="alert__content">
    			<p>Si vous êtes un responsable du site, merci de vous connecter à votre panneau de contrôle et créez votre premier modèle.</p>
    		</div>
  		</div>
  		<div class="alert alert--attention">
            <div class="alert__icon">
            ...
            <div class="alert__content">
    			<p>Si c'est la première fois que vous utilisez le CMS ExpressionEngine, assurez-vous de <a href="https://docs.expressionengine.com/latest/getting-started/the-big-picture.html">prendre connaissance de la documentation</a> pour démarrer sur de bonnes bases.</p>
    		</div>
  		</div>
  	</div>
  </div>
