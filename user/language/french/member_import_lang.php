...
'Champ affecté en doublon : %x',

'duplicate_member_id' =>
'ID de membre en doublon : "%x"<br />Nous vous recommandons de ne pas utiliser de balise &lt;member_id&gt; et d\'autoriser ExpressionEngine à incrémenter de manière automatique member_id',

'duplicate_username' =>
'Identifiant en doublon : ',
...
'file_loc_blurb' =>
'L\'emplacement du fichier doit être relative au dossier du panneau de contrôle de votre site. Exemple : ../membres.txt, si placé à la racine du site.',
...
'<b>Attention</b> : si vous ne reliez pas l\'une de vos données avec "Mot de Passe" (Password), un mot de passe encrypté aléatoire sera affecté à chaque membre importé. Ces utilisateurs devront donc réinitialiser leur mot de passe en cliquant sur le lien "J\'ai oublié mon mot de passe".',
...
'plaintext_passwords' =>
'Les mots de passes ne sont pas encryptés',
...
'xml_file_loc_blurb' =>
'L\'emplacement du fichier doit être relative au dossier du panneau de contrôle de votre site. Exemple : ../membres.xml, si placé à la racine du site.',
