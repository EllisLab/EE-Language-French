...
$lang = array(
    ...
    'rte_advanced_config' => 'Configuration avancée',
     ...
     'rte_advanced_config_warning' => '<p><b>Avertissement</b>: <b class="no">Seulement à l\’attention des utilisateurs expérimentés.</b> Soyez très prudent(e) en utilisant cette fonctionnalité et vérifiez votre travail.</p><p>La fourniture d\’une configuration invalide peut rendre les champs RTE inaccessibles.</p><p>Consultez les documents d\’edition: <a href="https://ckeditor.com/docs/ckeditor5/latest/installation/getting-started/configuration.html" target="_blank">CKEditor</a>, <a href="https://imperavi.com/redactor/docs/settings/" target="_blank">Redactor</a>,<a href="https://imperavi.com/redactorx/docs/settings/" target="_blank">RedactorX</a>.</p><p>Certaines options peuvent ne pas être disponibles sinon avoir été implémentées de manière différente. Nous conseillons d\’utiliser Full configuration (Configuration complète) comme base de départ.<p>',
